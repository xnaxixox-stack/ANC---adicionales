...
export const BaggageDetailDrawer: React.FC<BaggageDetailDrawerProps> = ({ isOpen, onClose, baggageItemId }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`fixed bottom-0 inset-x-0 md:top-0 md:right-0 md:left-auto md:h-full w-full max-h-[80vh] md:max-h-full md:max-w-md bg-white shadow-xl flex flex-col rounded-t-xl md:rounded-none transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-y-0 md:translate-x-0' : 'translate-y-full md:translate-y-0 md:translate-x-full'}`}>
